...
<img src="/docs/android/removing-the-browser-bar/google-play-signing.png" width="600px" />
...
3. Run the Asset Links Tool and search for your PWA's package ID (e.g. `com.myawesomepwa`): <br /> <img src="/docs/android/removing-the-browser-bar/asset-links-package-id.png" width="300px" />
4. Tap your PWA's package ID to view its asset links, then tap `Copy Signature` <br /> <img src="/docs/android/removing-the-browser-bar/asset-links-details.png" width="300px" />
