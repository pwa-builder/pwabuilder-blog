...
![A Screenshot of the Google Play console dashboard](/docs/android/removing-the-browser-bar/google-play-console-dashboard.png)
...
3. Run the Asset Links Tool and search for your PWA's package ID (e.g. `com.myawesomepwa`):
 ![A screenshot of the Asset Links Tool app showing the package ID](/docs/android/removing-the-browser-bar/asset-links-package-id.png)
4. Tap your PWA's package ID to view its asset links, then tap `Copy Signature`:
![A screenshot of the Asset Links Tool app showing the asset link details](/docs/android/removing-the-browser-bar/asset-links-details.png)
