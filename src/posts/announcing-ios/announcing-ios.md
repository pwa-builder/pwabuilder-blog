...
Note that PWABuilder's other platforms, including [our Windows platform](https://blog.pwabuilder.com/docs/windows-platform/), can use Push Notifications and other PWA capabilities using web standards-based code, and without the need of native wrappers.
