...
During the last 2 months I've been working on a project that addresses these questions: the PWABuilder Manifest Previewer. This is a <a href="https://blog.pwabuilder.com/posts/building-pwas-with-web-components!/" target="_blank">web component</a> that given a web manifest and the PWA's URL, it shows you what the values in this `json` file are used for in different platforms. As an example, here's the manifest visualizer showing what the <a href="https://www.w3.org/TR/appmanifest/#name-member" target="_blank">name</a> attribute appears in the Windows start menu:
